...
struct WebserviceConstants {
    ...
    static let ACCEPT_HEADER_PERMISSION_WRITE = "application/vnd.netid.permission-center.netid-subject-status-v2+json"
    static let ACCEPT_HEADER_PERMISSION_READ = "application/vnd.netid.permission-center.netid-user-status-v2+json"
    ...
    static let PERMISSION_QUERY_PARAM_IDENTIFIER_KEY = "q.identifier.in"
}
